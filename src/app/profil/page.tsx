...
// import { Layout } from '@/app/configure/layout';
...
//   const user = await getUserData(kindeUser.email);
...
//       <h1 className="text-3xl font-bold mb-6">Profil de {user.firstName} {user.lastName}</h1>
